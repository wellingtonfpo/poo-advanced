-- Habilita o suporte a chaves estrangeiras (necessário no SQLite)
PRAGMA foreign_keys = ON;

-- Usa IF EXISTS para não gerar erro caso o banco esteja vazio na primeira execução
DROP TABLE IF EXISTS authorISBN;
DROP TABLE IF EXISTS titles;
DROP TABLE IF EXISTS authors;

CREATE TABLE authors (
    -- No SQLite, colunas de autoincremento devem usar INTEGER PRIMARY KEY AUTOINCREMENT
