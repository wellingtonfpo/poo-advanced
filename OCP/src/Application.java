...
import notify.v2.EmailNotificationService;
import notify.v2.factory.SESEmailNotificationFactory;
import notify.v2.factory.SMTPEmailNotificationFactory;
import notify.v2.factory.SendGripEmailNotificationFactory;
...
//    System.out.println("Phone validation (v2): " + validator.validate("phone", "1234567890"));
    ...
    emailService.sendEmail(new SMTPEmailNotificationFactory(), "ligton.ribeiro@gmail.com", "Messagem");
    IO.println();

    emailService.sendEmail(new SESEmailNotificationFactory(), "ligton.ribeiro@gmail.com", "Messagem");
    IO.println();

    emailService.sendEmail(new SendGripEmailNotificationFactory(), "ligton.ribeiro@gmail.com", "Messagem");
    IO.println();
}
